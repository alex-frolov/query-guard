...
final class FakeOrmAdapter implements OrmAdapter
{
     ...
     * @param string       $platform reported through an explainer, the way both real
     *                               adapters do it, whether or not tier 2 is on
     */
    ...
    {
        return '' === $this->platform ? [] : ['default' => new FakeExplainer($this->platform)];
    }
